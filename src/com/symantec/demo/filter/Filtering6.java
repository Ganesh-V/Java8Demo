...
public class Filtering6 {
	...
	public static void main(String[] args) {
		...
		Predicate<Student> isProperAge = student -> student.getAge() >= 0;		
		Predicate<Student> isMale = student -> student.getGender() == Male;
		Predicate<Student> isProperAgeMale = isProperAge.and(isMale);
		
		List<Student> properAgeStudents = filterMaleStudent(students, isProperAgeMale);
