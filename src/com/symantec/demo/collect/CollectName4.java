...
public class CollectName4 {
	...
	public static Map<Grade, List<String>> getMap(List<Student> students) {
		return students.stream().collect(groupingBy(Student::getGrade, mapping(Student::getName, toList())));
	}
}
